...
ObjectDefinitionMenu.render = function() {
  ...
  instructions.setAttribute('position', `0 ${height/2 - 0.10} 0`);
...
ObjectDefinitionMenu.createResetButton = function() {
  ...
  const resetBtn = this.createButton({
    ...
    position: '0 -0.02 0', // Position below other buttons
...
ObjectDefinitionMenu.createSidePanel = function() {
  ...
  this.sidePanel.setAttribute('position', `${width/2 + 0.2} 0 0`); // Positioned to the right
