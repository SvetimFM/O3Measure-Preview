...
WallCalibrationMenu.createCalibrationButtons = function() {
  ...
  sceneState ? sceneState.getState('calibration.wall') : null;
  ...
  const buttons = [
    { 
      ...
      width: 0.2,
      height: 0.03,
      handler: () => this.handleButtonPress('adjust-wall')
    },
    { 
      ...
      width: 0.2,
      height: 0.03,
      handler: () => this.handleButtonPress('reset-wall-calibration')
    }
  ];
...
WallCalibrationMenu.createBackButton = function() {
  ...
  const button = this.createButton({
    ...
    width: 0.2,
    height: 0.03,
    handler: () => this.handleButtonPress('back-to-main-menu')
  });
...
WallCalibrationMenu.handleButtonPress = function(action) {
